...
export const PokemonCard: React.FC<PokemonCardProps> = ({ name, url }) => {
  ...
  return (
    <li className="pokemonCard" onClick={handleCardClick} style={{ cursor: 'pointer' }}>
      <button type="button" onClick={handleToggleLike} aria-label={liked ? "Unlike" : "Like"}>
        {liked ? (
          <svg xmlns="http://w3.org" height="24px" viewBox="0 -960 960 960" width="24px" fill="#EA3323">
